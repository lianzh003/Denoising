...
def visualize(model,
    ...
    scale = 70  # to be more accurate computed from .DoseGridScaling parameter
    ...
    for current_image_name in model.visualized_images:
        ...
        visualizer.save_image(image_numpy, os.path.join(output_dir, 'web', 'images', img_path), min_v, max_v, cmap='jet')
        # visualizer.save_image(image_numpy, os.path.join(output_dir, 'web', 'images', img_path), cmap='jet')
